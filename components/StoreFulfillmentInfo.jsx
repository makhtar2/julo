...
export function CartFulfillmentBanner() {
    return (
        <div className="mb-5 sm:mb-8 rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-4 sm:p-5 shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3 p-3 rounded-xl bg-slate-50 border border-slate-100">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 mt-3 text-[10px] font-black text-blue-600 uppercase tracking-widest hover:text-blue-700"
                        >
