                ...
                >
                    <div className="bg-slate-900 h-32 relative">
                        <div className="absolute -bottom-12 left-8 sm:left-12">
                            <div className="size-24 sm:size-32 bg-blue-600 rounded-[2rem] border-4 border-white flex items-center justify-center text-white text-3xl sm:text-4xl font-black shadow-lg">
                    ...
                    >
                        ...
                        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-black transition-all shadow-lg shadow-slate-900/10 active:scale-95"
                                >
                                    <Plus size={14} />
                                    Ajouter
                                </button>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {profileItems.map((item, index) => (
                                <Link key={index} href={item.href} className="block group">
                                    <div className="h-full bg-white p-6 rounded-[2rem] border border-slate-100 shadow-lg shadow-slate-200/30 flex items-center justify-between hover:border-blue-200 hover:shadow-blue-600/5 transition-all">
                                        <div className="flex items-center gap-4">
                                            <div
                        ...
                        <div className="bg-blue-600 rounded-[2rem] p-8 text-white relative overflow-hidden group">
                            <div className="relative z-10">
                                ...
                                <p className="text-blue-50 text-sm font-medium mb-6 max-w-[240px]">
                                    Notre équipe est là pour vous accompagner dans vos achats.
                                </p>
                                <Link
                                    href="/contact"
                                    className="inline-flex px-6 py-3 bg-white text-blue-600 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-colors"
                                >
                                    Nous contacter
                                </Link>
                            </div>
                            <Package
                                size={120}
                                className="absolute -bottom-8 -right-8 text-white/10 rotate-12 group-hover:rotate-0 transition-transform duration-500"
                            />
                        </div>
                    </motion.div>
                </div>
