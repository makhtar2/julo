...
export const JULO_CATEGORIES = [
    ...
    { id: 'cat-8', name: 'Sérigraphie & Goodies', slug: 'serigraphie-goodies' },
];
...
export const JULO_MOCK_PRODUCTS = [
    ...
    // ==========================================
    // 8. SÉRIGRAPHIE, TEXTILE & GOODIES JULO STUDIO
    // ==========================================
    {
        id: 'julo-tshirt-oversize-studio',
        name: 'T-Shirt Premium JULO Studio 100% Coton Peigné 240g/m²',
        description:
            'T-shirt lourd de qualité supérieure conçu par JULO Atelier. Coton peigné 240g/m² avec toucher soyeux, coupe oversize contemporaine, col rond renforcé et impression sérigraphique artisanale haute densité. Disponible à l’unité ou en commande personnalisée avec votre propre visuel.',
        mrp: 18000,
        price: 12000,
        stock: 50,
        inStock: true,
        category: 'Sérigraphie & Goodies',
        categoryId: 'cat-8',
        Category: { id: 'cat-8', name: 'Sérigraphie & Goodies' },
        images: [
    ...
    },
    {
        ...
        description:
            'Sweat à capuche molletonné ultra-confortable 350g/m² avec intérieur brossé polaire. Personnalisation intégrale pour votre marque, votre entreprise, votre promo d’école ou votre projet personnel (logo coeur, grand dos, manches). Devis et simulation instantanés sur WhatsApp.',
        mrp: 30000,
        price: 22000,
        stock: 30,
        inStock: true,
        ...
        specs: {
            Matière: '80% Coton peigné / 20% Polyester 350 g/m²',
            ...
            Quantité: 'Disponible dès 1 pièce jusqu’à 1000+ pièces',
        },
        rating: [
            {
                rating: 5,
                review: 'Rendu impeccable pour les pulls de notre promotion d’école.',
    ...
    },
    {
        ...
        description:
            'Pack professionnel pour équiper vos équipes, salons et événements d’entreprise au Sénégal. Polos en piqué de coton 220g/m² avec col tricoté et patte 3 boutons. Personnalisation de votre logo d’entreprise sur le cœur et dans le dos.',
        mrp: 130000,
        price: 95000,
        stock: 15,
        inStock: true,
        ...
        specs: {
            Quantité: 'Pack de 10 Polos (tailles panachables S à 3XL)',
            Matière: 'Piqué de coton peigné 220 g/m²',
            Personnalisation: 'Logo brodé ou sérigraphié inclus',
            Délai: '48h à 72h avec livraison express partout au Sénégal',
        },
        rating: [
            {
                rating: 5,
                review: 'Excellente finition pour notre agence de com à Dakar.',
    ...
    {
        id: 'julo-casquette-trucker-brodee',
        name: 'Casquette Trucker / Baseball Brodée Personnalisée JULO',
        description:
            'Casquette structurée 5 ou 6 panneaux avec visière pré-courbée, panneau arrière en maille respirante et fermeture réglable snapback. Broderie 3D en relief ou patch personnalisé de votre logo.',
        mrp: 12000,
        price: 7500,
        stock: 40,
        inStock: true,
        ...
        specs: {
            Modèle: 'Trucker Mesh ou Baseball 100% Coton Chino',
            Personnalisation: 'Broderie 3D relief haute précision',
            Fermeture: 'Snapback réglable taille unique',
        },
        rating: [
            {
                rating: 5,
                review: 'Broderie très nette et casquette de qualité.',
                user: { name: 'Thierno Diallo' },
            },
        ],
    ...
    },
    {
        ...
        description:
            'Sac en toile canvas épaisse 300g/m² avec longues anses renforcées de 70 cm. Idéal pour goodies d’entreprises, boutiques de mode ou cadeaux clients à Dakar. Sérigraphie haute résistance 1 ou 2 couleurs.',
        mrp: 8000,
        price: 5000,
        stock: 50,
        inStock: true,
    ...
    {
        id: 'julo-rollup-banner-pro',
        name: 'Roll-Up Banner Publicitaire 85x200cm pour Salons & Boutiques',
        description:
            'Support de communication grand format avec structure en aluminium renforcé, bâche indéchirable anti-reflet avec impression numérique HD et housse de transport rembourrée incluse. Idéal pour vos événements à Dakar et partout au Sénégal.',
        mrp: 60000,
        price: 45000,
        stock: 12,
        inStock: true,
        ...
        specs: {
            ...
            Support: 'Bâche PVC 450g satinée anti-reflet',
            Structure: 'Aluminium léger autoportant avec pieds pivotants',
            Délai: 'Impression express en 24h',
        },
        rating: [
            {
                rating: 5,
                review: 'Impression nette et lumineuse pour notre stand à la FIDAK.',
                user: { name: 'Bocar Ly' },
            },
        ],
